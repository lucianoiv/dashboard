  ...
  return (
    <>
      <div className="highlights">
        ...
        ></img>
        <p>
          Max. UV hoy: <strong>{indiceUV}</strong>
        </p>
      </div>
      <div className="highlights">
        <img
        ...
        ></img>
        <p>
          VIENTO <strong>{wind_speed}</strong> km/h
        </p>
      </div>
      <div className="highlights">
        <img
        ...
        ></img>
        <p>
          AMANECER <strong>{sunrise_time}</strong>
        </p>
        <br></br>
        <img
        ...
        ></img>
        <p>
          ANOCHECER <strong>{sunset_time}</strong>
        </p>
      </div>
      <div className="highlights">
        <img
        ...
        ></img>
        <p>
          LLUVIA <strong>{precipitation}</strong>%
        </p>
      </div>
      <div className="highlights">
        <img
          src="https://bmcdn.nl/assets/weather-icons/v3.0/fill/svg/pollen.svg"
          style={{ width: 40 }}
          alt="icon"
        ></img>
        <p>
          Calidad del aire: <strong>{airQualityIndex}</strong>
        </p>
      </div>
      <div className="highlights">
